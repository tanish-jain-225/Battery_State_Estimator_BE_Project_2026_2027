...
| --- | --- | --- |
| `battery-state-simulator` | `software/simulator` | `gunicorn -b 0.0.0.0:$PORT --timeout 300 --workers 1 app:app` |
| `battery-state-visualiser` | `software/visualiser` | `gunicorn -b 0.0.0.0:$PORT --timeout 300 --workers 1 app:app` |
