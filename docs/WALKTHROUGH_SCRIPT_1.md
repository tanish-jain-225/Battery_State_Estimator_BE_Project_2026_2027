...
- **Visual Screen**: Slide 1 (Title & Team Details)
- **Narration**:
...
- **Visual Screen**: Slide 2 (Problem & Proposed Solution)
- **Narration**:
...
- **Visual Screen**: Slide 3 (Phase 1 — Completed Work)
- **Narration**:
...
- **Visual Screen**: Slide 4 (Phase 2 — In Progress Work)
- **Narration**:
...
- **Visual Screen**: Slide 5 (Phase 3 — Final Goal & Timeline)
- **Narration**:
